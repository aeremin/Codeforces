...
template <typename UnderlyingInt, UnderlyingInt MOD>
Residue<UnderlyingInt, MOD> operator+(Residue<UnderlyingInt, MOD> a, Residue<UnderlyingInt, MOD> b) {
    return a += b;
}
...
template <typename UnderlyingInt, UnderlyingInt MOD>
Residue<UnderlyingInt, MOD> operator+(Residue<UnderlyingInt, MOD> a, UnderlyingInt b) {
    return a += b;
}
...
template <typename UnderlyingInt, UnderlyingInt MOD>
std::ostream& operator<<(std::ostream& outStream, Residue<UnderlyingInt, MOD> a) {
