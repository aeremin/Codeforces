...
IterationResult bfs(const GraphT& graph, const VertexListT& starting_vertices, const OnSeeT& on_see,
...
IterationResult bfs(const GraphT& graph, const std::initializer_list<int>& starting_vertices, const OnSeeT& on_see,
                    const OnEnterT& on_enter, const OnExitT& on_exit) {
    return bfs<GraphT, std::initializer_list<int>, OnSeeT, OnEnterT, OnExitT>(graph, starting_vertices, on_see,
                                                                              on_enter, on_exit);
}

template <typename GraphT, typename VertexListT, typename VisitorT>
IterationResult bfs(const GraphT& graph, const VertexListT& starting_vertices, const VisitorT& visitor) {
...
IterationResult bfs(const GraphT& graph, const std::initializer_list<int>& starting_vertices, const VisitorT& visitor) {
    return bfs<GraphT, std::initializer_list<int>, VisitorT>(graph, starting_vertices, visitor);
}
