...
#define DEFINE_HASH_1(TYPE_NAME, FIELD1) DEFINE_HASH_ABSTRACT(TYPE_NAME, a.FIELD1)

#define DEFINE_HASH_2(TYPE_NAME, FIELD1, FIELD2) DEFINE_HASH_ABSTRACT(TYPE_NAME, a.FIELD1 COMMA a.FIELD2)
