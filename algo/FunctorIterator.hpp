...
public:
    ...
    const FunctorIterator& operator++()    { ++i_; return *this; }
    const FunctorIterator& operator--()    { --i_; return *this; }

    const FunctorIterator& operator+=(IntegerType v) { i_ += v; return *this; }
    const FunctorIterator& operator-=(IntegerType v) { i_ -= v; return *this; }
...
template<typename IntegerType, class Functor>
FunctorIterator<IntegerType, Functor>  makeFunctorIterator(IntegerType i, Functor& f) { return FunctorIterator<IntegerType, Functor>(i, f); }